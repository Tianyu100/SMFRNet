...
#         only save latest 10 epoch weights
        if os.path.exists(f"save_weights/model_{epoch-40}.pth"):
            os.remove(f"save_weights/model_{epoch-40}.pth")
...
def parse_args():
    ...
    parser.add_argument("--data-path", default="./DUTS", help="DUTS root")
    ...
    parser.add_argument('--resume', default='save_weights/model_21.pth', help='resume from checkpoint')#save_weights/model_42.pth
